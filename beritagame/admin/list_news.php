...
<body>
    ...
    <main>
        ...
        <div class="form_div">
            ...
            <a href="add_news.php">= TAMBAH BARU</a><br><br>
        <form>
            <table border="1">
                <tr>
                    <th>No.</th>
                ...
                ?>
                    <tr>
                        ...
                        <td class="singkat"><?php echo $d['isi_berita']; ?></td>
                        <td><?php echo $d['watching_time']; ?></td>
                        <td>
                            <a href="script/update_news.php?id_berita=<?php echo $d['id_berita']; ?>">Update</a>
                            <a href="script/delete_news.php?id_berita=<?php echo $d['id_berita']; ?>">Delete</a>
                        </td>
                    </tr>
                    <?php
                }
